...
def main(argv=None):
    with tf.Graph().as_default():
        ...
        #jpegs = tf.FixedLenFeature(shape=[], dtype=tf.string)
        ...
        with tf.Session(config=config) as sess:
            ...
            classify_inputs_tensor_info = tf.saved_model.utils.build_tensor_info(images)
            classes_output_tensor_info = tf.saved_model.utils.build_tensor_info(classes)
            softmax_output_tensor_info = tf.saved_model.utils.build_tensor_info(softmax_output)
            ...
            print('Classify Inputs Tensor Info:')
            print(classify_inputs_tensor_info)
            print('Classes Output Tensor Info:')
            print(classes_output_tensor_info)
            print('Indices Output Tensor Info:')
            print(indices_output_tensor_info)
            print('Softmax Output Tensor Info:')
            print(softmax_output_tensor_info)
            print('Scores Output Tensor Info:')
            print(scores_output_tensor_info)
            ...
            classification_signature = (
                tf.saved_model.signature_def_utils.build_signature_def(
                    ...
                    outputs={
                        ...
                        indices_output_tensor_info, #classes_output_tensor_info,
            ...
            predict_inputs_tensor_info = tf.saved_model.utils.build_tensor_info(images)
            prediction_signature = (
                tf.saved_model.signature_def_utils.build_signature_def(
                    inputs={'images': predict_inputs_tensor_info},
                    outputs={
                        #'classes': classes_output_tensor_info,
                        'classes': indices_output_tensor_info,
